...
/**
 * Servlet implementation class DesignerPortfolioListServlet
 */
@WebServlet(name = "DesignerPortfolioList", urlPatterns = { "/designerPortfolioList" })
public class DesignerPortfolioListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesignerPortfolioListServlet() {
        super();
