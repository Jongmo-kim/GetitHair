...
public class Reserve {
	...
	public Reserve(int reserveNo, Customer customer, Designer designer, Hairshop shop, Stylelist stylelist,
			String reserveTitle, String reserveStatus, String reserveCustReq, String reserveDesignerReq,
			String reserveDesignerMemo, Date reserveDate, Date reserveStartdate, Date reserveEndDate) {
		super();
	...
	public String toString() {
		return "Reserve [reserveNo=" + reserveNo + ", customer=" + customer + ", designer=" + designer + ", shop="
				+ shop + ", stylelist=" + stylelist + ", reserveTitle=" + reserveTitle + ", reserveStatus="
				+ reserveStatus + ", reserveCustReq=" + reserveCustReq + ", reserveDesignerReq=" + reserveDesignerReq
				+ ", reserveDesignerMemo=" + reserveDesignerMemo + ", reserveDate=" + reserveDate
				+ ", reserveStartdate=" + reserveStartdate + ", reserveEndDate=" + reserveEndDate + "]";
	}
