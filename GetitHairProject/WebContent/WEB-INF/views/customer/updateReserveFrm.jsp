...
<body>
	<div id="wrapper">
		<ul class="tabs">
			<li><a href="/updateReserveFrm?customerNo=<%=customer.getCustomerNo()%>&selStatus=전체&reqPage=1">전체</a></li>
			<li><a href="/updateReserveFrm?customerNo=<%=customer.getCustomerNo()%>&selStatus=예약&reqPage=1">예약</a></li>
			<li><a href="/updateReserveFrm?customerNo=<%=customer.getCustomerNo()%>&selStatus=완료&reqPage=1">완료</a></li>
			<li><a href="/updateReserveFrm?customerNo=<%=customer.getCustomerNo()%>&selStatus=취소&reqPage=1">취소</a></li>			
		</ul>
		<div class="tab_container">
			<div id="tab4" class="tab_content">
				<%if(selStatus.equals("reserve_status")) {%>
					<h1>전체영역</h1>
				<%} else{%>
					<h1><%=selStatus%>영역
				<%} %>
