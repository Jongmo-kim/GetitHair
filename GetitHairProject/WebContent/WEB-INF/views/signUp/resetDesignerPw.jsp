...
<body>
	...
	<form method="post" action="/designerResetPw">
		...
		<input type="hidden" name="designerId" value="<%= designer.getDesignerId() %>">
		<table class="table">
			<tr>
				<td>
					<div class="password inputBox">
						<input autofocus type="password" class="form-textbox"  id ="pwInput"
							name="designerPw"> <span class="form-label label-focused">암호
							설정</span>
							<span id="pwInfo"></span>
					</div>
				</td>
				...
				<td>
					<div class="password inputBox">
						<input type="password" class="form-textbox" id ="pwreInput"
							name="designerPwRe"> <span class="form-label">암호
							설정</span>
